# KhaosBox v0.5 产品规划：网站收藏与常用网址

## 定位

v0.5 的目标是把 KhaosBox 从“空间化资料与任务容器”推进到“个人网址资产管理”。用户不仅能把链接丢进 box，还能系统地收藏、导入、整理、搜索、打开、导出和沉淀常用网站。

v0.5 不应该只是给 URL item 增加收藏按钮。它要回答三个问题：

1. 我从浏览器带来的大量收藏夹如何进入 KhaosBox
2. 我每天反复打开的网站如何自然浮现
...
1. 浏览器可导入的书签 HTML 文件
2. KhaosBox JSON 备份中的 Bookmark 数据
...
KhaosBox 内部字段如 openCount、isPinned、tags 可以保留在 JSON 备份，不强行塞进浏览器书签 HTML。
...
1. 用户能把浏览器收藏夹导入 KhaosBox，并看懂导入结果
2. 用户能把 KhaosBox 收藏导出回浏览器可识别格式
3. 用户能把常用网址固定到快速入口
4. 高频打开的网址能自动浮现
5. 导入大量收藏不会破坏桌面工作区
