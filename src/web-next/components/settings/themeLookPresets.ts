    ...
    },
    {
      ...
      colors: {
        light: {
          ...
          text: '#0b57d0',
          blue: '#0b57d0',
          createBackground: '#0b57d0',
          settingsChrome: '#e8f0fe',
          settingsHover: '#aecbfa',
        },
        dark: {
          canvas: '#041e49',
          panel: '#0b2d5c',
          ...
          text: '#aecbfa',
          blue: '#a8c7fa',
          createBackground: '#a8c7fa',
          settingsChrome: '#062e6f',
          settingsHover: '#174ea6',
        },
      },
    },
    {
      ...
      colors: {
        light: {
          ...
          settingsChrome: '#e6f4ea',
          settingsHover: '#a8dab5',
        },
        dark: {
          canvas: '#0a2814',
          panel: '#0f3d1e',
          ...
          text: '#a8dab5',
          blue: '#6dd58c',
          createBackground: '#6dd58c',
          settingsChrome: '#0b3318',
          settingsHover: '#0d652d',
        },
      },
    },
    {
      ...
      colors: {
        light: {
          ...
          settingsChrome: '#fce8e6',
          settingsHover: '#f6aea9',
        },
        dark: {
          canvas: '#3b0a08',
          panel: '#5c1210',
          ...
          settingsChrome: '#4a0e0c',
          settingsHover: '#a50e0e',
        },
      },
    },
  ],
    ...
    },
    {
      ...
      colors: {
        light: {
          ...
          settingsChrome: '#ececf8',
          settingsHover: '#d8d8f0',
        },
        dark: {
          canvas: '#12121f',
          panel: '#1e1e32',
          ...
          settingsChrome: '#161628',
          settingsHover: '#2a2a4a',
        },
      },
    },
    {
      ...
      colors: {
        light: {
          ...
          settingsChrome: '#e4f6f8',
          settingsHover: '#b8e8ef',
        },
        dark: {
          canvas: '#0a181a',
          panel: '#14282c',
          ...
          settingsChrome: '#0e1f22',
          settingsHover: '#1e4048',
        },
      },
    },
    {
      ...
      colors: {
        light: {
          ...
          settingsChrome: '#fceef3',
          settingsHover: '#ffd0dd',
        },
        dark: {
          canvas: '#1f0e14',
          panel: '#321822',
          ...
          settingsChrome: '#180a10',
          settingsHover: '#4a1c2c',
        },
      },
    },
  ],
