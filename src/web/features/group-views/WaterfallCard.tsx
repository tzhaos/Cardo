        ...
        <>
          <header className="cardo-waterfall-card-header" onPointerDown={beginDrag}>
            ...
            {titleRename.renaming ? (
              <Input
                ...
                className="cardo-inline-rename cardo-waterfall-card-title-input"
                data-no-drag
              ...
              <strong
                className="cardo-waterfall-card-title"
                data-no-drag
            ...
            <IconButton
              className="cardo-waterfall-card-action"
              data-no-drag
            ...
            <IconButton
              className="cardo-waterfall-card-action cardo-waterfall-card-delete"
              data-no-drag
          ...
          <div className="cardo-waterfall-card-body" data-no-box-drag>
            ...
            {box.items.length ? (
              ...
              <div className="cardo-waterfall-card-empty">{t('box.emptyHint')}</div>
            ) : null}
          </div>
        </>
      )}
